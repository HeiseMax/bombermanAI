...
from .state_to_features import state_to_features_bomb, state_to_features_crates, state_to_features_bomb_2, state_to_features_fight, state_to_features_default
...
def setup(self):
    ...
    self.modes = {"DEFAULT": state_to_features,
    ...
    #if not os.path.isfile("mode_stats.pt"):
        #with open("mode-stats.pt", "wb") as file:
           # pickle.dump([], file)
...
def act(self, game_state: dict) -> str:
    ...
    #     print(len(mode_stats))
    #     modes, mode_counts = np.unique(mode_stats, return_counts=True)
    #     print(modes, mode_counts)
    #mode_stats.append(mode)
    #with open("mode-stats.pt", "wb") as file:
     #  pickle.dump(mode_stats, file)

    if False: # mode == "DEFAULT":
